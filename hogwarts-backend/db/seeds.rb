...
hogwarts_house_collection.each do |house|
    ...
    (1..house_size).each do |poke|
        ...
        User.create(username: username, patronus: "dog", house_id: house.id)
      end
    end
