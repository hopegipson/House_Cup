...
DATA3 = {
    question_keys: %w[question answers quiz correct_answer gryffindor_answer hufflepuff_answer slytherin_answer ravenclaw_answer],
     questions: [
       ...
       ['Which wizard do you look up to?', {"A"=>"Hermione Granger", "B"=>"Draco Malfoy", "C"=>"Harry Potter", "D"=>"Ron Weasley"}, quiz2, nil, "C", "D", "A", "B"],
       ...
       ['Four boxes are placed before you. Which would you try and open?', {"A"=>"The small pewter box", "B"=>"The ornate golden casket", "C"=>"The small tortoiseshell box", "D"=>"The gleaming jet black box"}, quiz2, nil, "A", "C", "B", "D"],
       ['You and two friends need to cross a bridge guarded by a river troll who insists on fighting one of you before he will let all of you pass. Do you:', {"A"=>"Suggest drawing lots to decide who will fight", "B"=>"Suggest all three of you should fight", "C"=>"Attempt to confuse the troll so you can pass without fighting", "D"=>"Volunteer to fight"}, quiz2, nil, "D", "A", "C", "B"],
       ['You enter an enchanted garden. What would you be most curious to examine first?', {"A"=>"The bubbling pool", "B"=>"The silver leafed tree", "C"=>"The fat red toadstools", "D"=>"The statue of an old wizard"}, quiz2, nil, "D", "C", "B", "A"],
       ['Four goblets are placed before you, which do you drink?', {"A"=>"The foaming, frothing, silvery liquid that sparkles as though containing ground diamonds.", "B"=>"The smooth, thick, richly purple drink that gives off a delicious smell of chocolate and plums.	", "C"=>"The golden liquid so bright that it hurts the eye, and which makes sunspots dance all around the room.	", "D"=>"The mysterious black liquid that gleams like ink, and gives off fumes that make you see strange visions.	"}, quiz2, nil, "C", "B", "A", "D"],
       ['What kind of instrument most pleases your ear?', {"A"=>"The violin", "B"=>"The trumpet", "C"=>"The piano", "D"=>"The drum"}, quiz2, nil, "D", "B", "C", "A"],
       ['After you have died, what would you most like for people to do when they hear your name?', {"A"=>"Miss you but smile", "B"=>"Ask for more stories of your adventures", "C"=>"Think with admiration of your achievements", "D"=>"I don't care what they think when I'm dead, only what they think as I'm alive"}, quiz2, nil, "B", "A", "C", "D"],
       ...
       ['What pet would you most like?', {"A"=>"Dragon Toad", "B"=>"White Owl", "C"=>"Common Toad", "D"=>"Black Cat"}, quiz2, nil, "A", "C", "B", "D"],
       ['What power would you most want?', {"A"=>"Power of Invisibility", "B"=>"Power to Change Appearance", "C"=>"Superhuman Strength", "D"=>"Power to Change the Past"}, quiz2, nil, "A", "C", "B", "D"],
       ['Which road tempts you most?', {"A"=>"The wide, sunny, grassy lane", "B"=>"The narrow, dark, lantern-lit alley", "C"=>"The twisting, leaf-strewn path through the woods", "D"=>"The cobbled street lined with ancient buildings"}, quiz2, nil, "C", "A", "D", "B"],
       ['What are you most looking forward to learning at Hogwarts?', {"A"=>"Secrets About The Castle", "B"=>"About Magical Creatures", "C"=>"Transfiguration", "D"=>"Hexes and Jinxes"}, quiz2, nil, "A", "B", "C", "D"],
       ['Which of the following would you most like to study?', {"A"=>"Vampires", "B"=>"Goblins", "C"=>"Trolls", "D"=>"Werewolves"}, quiz2, nil, "D", "C", "B", "A"],
       ['Would you rather be:', {"A"=>"Feared", "B"=>"Imitated", "C"=>"Liked", "D"=>"Praised"}, quiz2, nil, "D", "C", "B", "A"]
     ]
   }.freeze
